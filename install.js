...
var displayName         = "CookieSwap"; // The name displayed to the user (don't include the version)
var version             = "0.5.1";
var name                = "cookieswap"; // The leafname of the JAR file (without the .jar part)
...
var prefs               = [ "cookieSwap.js" ];
var components          = [ "CookieSwapProfileMgr.js" ];
var searchPlugins       = [  ];
