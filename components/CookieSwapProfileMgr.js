...
CookieSwapProfileMgr.prototype = {
  classID: Components.ID(CLASS_ID),                                          //FF4
  QueryInterface: XPCOMUtils.generateQI([Components.interfaces.nsIProfile]), //FF4
...
{
    var NSGetFactory = XPCOMUtils.generateNSGetFactory([CookieSwapProfileMgr]);   
    //[OLD]const NSGetFactory = XPCOMUtils.generateNSGetFactory([CookieSwapProfileMgr]);
}
else  
{
    var NSGetModule = XPCOMUtils.generateNSGetModule([CookieSwapProfileMgrModule]);  
    //[OLD]function NSGetModule(aCompMgr, aFileSpec) { return CookieSwapProfileMgrModule; }
}
